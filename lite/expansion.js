...
function initExpansion(){$('#treebtn').onclick=()=>{if(p)panelOpen('tree')};$('#labelbtn').onclick=()=>{if(p)toggleLootLabels()};$('#skillcycle').onclick=cycleSkill;addEventListener('keydown',e=>{if(e.repeat||mode!=='play')return;if(e.key.toLowerCase()==='l')panelOpen('tree');if(e.key.toLowerCase()==='q')cycleSkill()})}
